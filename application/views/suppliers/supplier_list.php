			...
			<div class="x_content margin-top-20">
				<div class="row margin-top-20">
					<div class="col-lg-6 col-lg-offset-6 text-center">
						<form action="<?php echo site_url('suppliers/search'); ?>">
						...
						<table class="table table-striped table-hover text-14">
							...
							<tbody>
								...
								<tr id="row<?php echo $row->sID;?>">
									<td class="col-md-4">
										<a href="<?php echo site_url('suppliers/edit/' . $row->id);?>" class="text-link">
									...
									<td class="text-center col-md-2">
										...
										<button class="btn btn-danger btn-sm" onclick="delete_supplier(this, '<?=$row->sID;?>', '<?=addslashes($row->name);?>')">
