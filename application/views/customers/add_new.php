			...
			<div class="x_content margin-top-20">
				<div class="row">
					<div class="col-md-10">
						...
						<form class="form-horizontal form-label-left input_mask margin-top-20" id="formNewCustomer">
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
									Company Name <span class="required">*</span>
								</label>
								<div class="col-md-8 col-sm-8 col-xs-12">
									<input type="text" name="customer_name" id="customerName" required="required" 
							...
							<div class="form-group">
								<div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
									...
									<div class="col-md-5">
										<button type="submit" class="btn btn-success btn-block">Save New Customer</button>
									</div>
								</div>
							</div>
