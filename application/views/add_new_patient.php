		...
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-lg-9 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 body-content">
					<form class="form-horizontal form-data-entry" method="POST" action="<?php echo site_url('patients/save_patient');?>">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-lg-9">
									<textarea rows="2" class="form-control" name="address" placeholder="Present Address"></textarea>
								</div>
							</div>
